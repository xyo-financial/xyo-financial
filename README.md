...
* 🔐 **Encryption & Cryptographic Standards**  
  All data in transit is enforced via TLS 1.3 with Perfect Forward Secrecy (PFS); data at rest is encrypted using AES-256-GCM under FIPS 140-3 validated key management.<br/>
